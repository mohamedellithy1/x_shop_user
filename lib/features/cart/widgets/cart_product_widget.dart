    ...
    return Stack(
      children: [
        Padding(
          ...
          child: GetBuilder<MarketCartController>(builder: (cartController) {
            return Slidable(
              key: UniqueKey(),
                  ...
                  SlidableAction(
                    ...
                    borderRadius: BorderRadius.horizontal(
                        right: Radius.circular(
                            Get.find<LocalizationController>(tag: 'xmarket').isLtr
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                              ...
                              children: [
                                widget.cart.product!.imageFullUrl != null
                                    ? Stack(
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: CustomImageWidget(
                                              image:
                                                  '${widget.cart.product!.imageFullUrl}',
                                              height: 60,
                                              width: 60,
                                              fit: BoxFit.cover,
                                              isFood: true,
                                    ...
                                    : const SizedBox(),
                                SizedBox(
                                    width: widget.cart.product!.imageFullUrl !=
                                            null
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        Row(children: [
                                          Flexible(
                                            child: Text(
                                              '${widget.cart.product!.name!}${((widget.cart.product!.isWeightBased ?? false) && widget.cart.requestedWeight != null) ? ' ( الوزن : ${widget.cart.requestedWeight})' : ''}',
                                    ...
                                    child: Row(children: [
                                            ...
                                            : () {
                                                if (widget.cart.quantity! == 1) {
                                                  cartController.removeFromCart(
                                                      widget.cartIndex);
                                                } else if (widget.cart.product!.isWeightBased ?? false) {
                                      ...
                                      QuantityButton(
                                        onTap: cartController.isLoading
                                            ? () {}
                                            : () {
                                                if (widget.cart.product!.isWeightBased ?? false) {
                                                  _showProductBottomSheet();
                                                } else {
                                                  cartController.setQuantity(
                                                      true, widget.cart);
