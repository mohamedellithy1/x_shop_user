...
class PricingViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // print(
    //     "Get.find<MarketSplashController>(tag: 'xmarket').configModel!.additionalChargeName${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.additionalChargeName} ");
    return Container(
              ...
              ? Padding(
                  ...
                  child: Column(children: [
                    ...
                    cartController.variationPrice > 0
                        ...
                        : const SizedBox(),
                    SizedBox(
                        height: cartController.addOns > 0
                            ? Dimensions.paddingSizeSmall
                            : 0),
                    cartController.itemDiscountPrice > 0
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
