    ...
    for (OnlineCartModel cart in onlineCartModel) {
      ...
      cartList.add(
        CartModel(
          ...
          planBundleDiscountType: cart.planBundleDiscountType,
          planBundleDiscountValue: cart.planBundleDiscountValue,
          planBundleDiscountAmount: cart.planBundleDiscountAmount,
          lineTotalBeforeDiscount: cart.lineTotalBeforeDiscount,
          lineTotalAfterDiscount: cart.lineTotalAfterDiscount,
