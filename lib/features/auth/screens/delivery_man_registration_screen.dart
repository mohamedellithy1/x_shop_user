...
class _DeliveryManRegistrationScreenState
  ...
  void initState() {
    ...
    deliverymanController.setCountryDialCode(CountryCode.fromCountryCode(
    ...
    deliverymanController.setDeliverymanAdditionalJoinUsPageData(
        isUpdate: false);
  }
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        if (isDesktop) {
          ...
          if (Get.find<DeliverymanRegistrationController>().selectedTabIndex ==
              2) {
            Get.find<DeliverymanRegistrationController>()
                .setSelectedTabIndex(1);
          } else if (Get.find<DeliverymanRegistrationController>()
                  .selectedTabIndex ==
              1) {
            Get.find<DeliverymanRegistrationController>()
      ...
      child: GetBuilder<DeliverymanRegistrationController>(
        ...
        bool additionalDataExist =
            deliverymanController.additionalList!.isNotEmpty;
              ...
              : AppBar(
                  ...
                  leading: IconButton(
                      ...
                      onPressed: () {
                        ...
                        } else if (deliverymanController.selectedTabIndex ==
                            1) {
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              _tabButton(
                                  title: 'verification_info'.tr,
                                  index: 1,
                                  isSelected: verificationInfoTab,
                                  onTap: () {
                                    if (_fNameController.text.isEmpty ||
                                        ...
                                        _confirmPasswordController
                                            .text.isEmpty ||
                                        deliverymanController.pickedImage ==
                                            null) {
                                      showCustomSnackBar(
            ...
            child: GetBuilder<DeliverymanRegistrationController>(
              ...
              return isDesktop
                  ? DeliverymanRegistrationWebScreen(
                      ...
                      buttonView: webButtonView(isDesktop))
                  : Column(children: [
                      generalInfoTab
                          ? GeneralInfoTab(
                      ...
                      verificationInfoTab
                          ...
                          : SizedBox(),
                      additionalDataExist && additionalInfoTab
                          ? AdditionalInfoTab(
                              deliverymanController: deliverymanController,
                              scrollController: _scrollController,
                            )
                          : SizedBox(),
                      (isDesktop || ResponsiveHelper.isWeb())
                          ? const SizedBox()
                          : buttonView(
  ...
  Widget buttonView(
      {required bool generalInfoTab,
      required bool verificationInfoTab,
      required bool additionalInfoTab,
      required bool additionalDataExist,
      required bool isDesktop}) {
    return GetBuilder<DeliverymanRegistrationController>(
        builder: (deliverymanController) {
      final progressValue = generalInfoTab
          ? 0.3
          : verificationInfoTab
              ? 0.6
              : 1.0;
      ...
      final buttonText = generalInfoTab
          ? 'next'.tr
          : verificationInfoTab
              ? 'next'.tr
              : 'submit'.tr;
      final buttonTextWithOutAdditionalInfo =
          generalInfoTab ? 'next'.tr : 'submit'.tr;
        ...
        children: [
          LinearProgressIndicator(
            backgroundColor:
                Theme.of(context).disabledColor.withValues(alpha: 0.5),
            minHeight: 2,
            value: additionalDataExist
                ? progressValue
                : progressValueWithOutAdditionalInfo,
          ),
          Container(
            ...
            child: CustomButtonWidget(
              ...
              buttonText: additionalDataExist
                  ? buttonText
                  : buttonTextWithOutAdditionalInfo,
              onPressed: !deliverymanController.acceptTerms
                  ...
                  : () async {
                      ...
                      String numberWithCountryCode =
                          deliverymanController.countryDialCode! + phone;
                      ...
                      if (generalInfoTab) {
                        if (infoFormKey!.currentState!.validate()) {
                          ...
                          } else if (deliverymanController.pickedImage ==
                              null) {
                            showCustomSnackBar(
                        ...
                        if (deliverymanController.selectedDmTypeId == null) {
                          showCustomSnackBar(
                              'please_select_deliveryman_type'.tr);
                        } else if (deliverymanController
                                .selectedDeliveryZoneId ==
                            null) {
                          showCustomSnackBar(
                              'please_select_zone_for_the_deliveryman'.tr);
                        } else if (deliverymanController.selectedVehicleId ==
                            null) {
                          showCustomSnackBar(
                              'please_select_vehicle_for_the_deliveryman'.tr);
                        } else if (deliverymanController.selectedIdentityType ==
                            null) {
                          showCustomSnackBar(
                              'please_select_identity_type_for_the_deliveryman'
                                  .tr);
                        } else if (identityNumber.isEmpty) {
                          showCustomSnackBar(
                              'enter_delivery_man_identity_number'.tr);
                        } else if (deliverymanController
                            .pickedIdentities.isEmpty) {
                          ...
                          if (additionalDataExist) {
                            ...
                            data.addAll(DeliveryManBodyModel(
                              ...
                              identityType:
                                  deliverymanController.selectedIdentityType,
                              earning: deliverymanController.selectedDmTypeId,
                              zoneId:
                                  deliverymanController.selectedDeliveryZoneId,
                              vehicleId:
                                  deliverymanController.selectedVehicleId,
                            ).toJson());
    ...
    return GetBuilder<DeliverymanRegistrationController>(
      ...
      return Container(
        ...
        child: CustomButtonWidget(
          ...
          fontSize:
              isDesktop ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge,
          isLoading: deliverymanController.isLoading,
          buttonText: (deliverymanController.dmStatus == 0.1 && !isDesktop)
              ? 'next'.tr
              : 'submit'.tr,
          margin: EdgeInsets.all((isDesktop || ResponsiveHelper.isWeb())
              ? 0
  ...
  void _addDeliveryMan(DeliverymanRegistrationController deliverymanController,
      {bool isDesktop = false, bool additionalDataExist = false}) async {
    String fName = _fNameController.text.trim();
    String lName = _lNameController.text.trim();
    String email = _emailController.text.trim();
    String phone = _phoneController.text.trim();
    ...
    if (deliverymanController.selectedDmTypeId == null) {
      ...
      data.addAll(DeliveryManBodyModel(
        ...
        email: email,
        identityNumber: identityNumber,
        identityType: deliverymanController.selectedIdentityType,
        earning: deliverymanController.selectedDmTypeId,
        zoneId: deliverymanController.selectedDeliveryZoneId,
          ...
          child: Form(
            ...
            child:
              ...
              CustomTextFieldWidget(
                ...
                countryDialCode: widget.deliverymanController.countryDialCode ??
                      ...
                      Align(
                        ...
                        child: Stack(clipBehavior: Clip.none, children: [
                          ClipRRect(
                            ...
                            child: widget.deliverymanController.pickedImage !=
                                    null
                                ? GetPlatform.isWeb
                                    ? Image.network(
                                        widget.deliverymanController
                          ...
                          widget.deliverymanController.pickedImage != null
                              ? Positioned(
                                  bottom: -10,
                                  right: -10,
                                  child: InkWell(
...
class VerificationInfoTab extends StatefulWidget {
  ...
  const VerificationInfoTab(
      {super.key,
      required this.identityNumberController,
      required this.identityNumberNode,
      required this.additionalInfoTab,
      required this.additionalDataExist});
          ...
          child: Column(children: [
            Container(
              ...
              child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('verification_info'.tr,
                        style: robotoSemiBold.copyWith(
                            fontSize: Dimensions.fontSizeLarge)),
                    SizedBox(height: Dimensions.paddingSizeExtraSmall),
                    Text('verification_info_subtitle'.tr,
                        style: robotoRegular.copyWith(
                            fontSize: Dimensions.fontSizeSmall,
                            color: Theme.of(context).hintColor)),
                    ...
                    const SizedBox(height: Dimensions.paddingSizeOverLarge),
                    deliverymanController.zoneList != null
                        ? deliverymanController.zoneList!.isNotEmpty
                            ? Stack(clipBehavior: Clip.none, children: [
                                CustomDropdownButton(
                                  hintText: 'select_delivery_zone'.tr,
                                  dropdownMenuItems: deliverymanController
                                      .zoneList!
                                      ...
                                      .toList(),
                                  selectedValue: deliverymanController
                                      .selectedDeliveryZoneId,
                                  onChanged: (value) {
                                    deliverymanController
                                        .setSelectedDeliveryZone(zoneId: value);
                                  },
                                ),
                                Positioned(
                                  left: 10,
                        ...
                        : Container(
                            ...
                            height: 50,
                            child: Center(
                              child: Text('no_zone_available'.tr,
                                  style: robotoRegular.copyWith(
                    ...
                    deliverymanController.vehicles != null
                        ? deliverymanController.vehicles!.isNotEmpty
                            ? Stack(clipBehavior: Clip.none, children: [
                                CustomDropdownButton(
                        ...
                        : Container(
                            ...
                            height: 50,
                            child: Center(
                              child: Text('no_vehicle_available'.tr,
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeDefault,
                                      color: Theme.of(context).hintColor)),
                            ),
                    ...
                    CustomTextFieldWidget(
                      ...
                      required: true,
                      isEnabled:
                          deliverymanController.selectedIdentityType != null,
