                              ...
                              Row(children: [
                                ...
                                const SizedBox(
                                    width:
                                        Dimensions.paddingSizeExtraOverLarge),
                                Expanded(
                                  child: deliverymanController.vehicles != null
                                      ? deliverymanController
                                              .vehicles!.isNotEmpty
                                          ? Stack(
                                              clipBehavior: Clip.none,
                              ...
                              Row(children: [
                                Expanded(
                                  child:
                                    ...
                                    CustomDropdownButton(
                                      ...
                                      items: deliverymanController
                                          .identityTypeList,
                                      selectedValue: deliverymanController
                                          .selectedIdentityType,
                                      onChanged: (value) {
                                        deliverymanController
                                            .setSelectedIdentityType(value);
                                      },
                                    ),
                                    Positioned(
                                      left: 10,
                                ...
                                Expanded(
                                  child: CustomTextFieldWidget(
                                    ...
                                    required: true,
                                    isEnabled: deliverymanController
                                            .selectedIdentityType !=
                                        null,
                                    validator: (value) =>
                                        ValidateCheck.validateEmptyText(
