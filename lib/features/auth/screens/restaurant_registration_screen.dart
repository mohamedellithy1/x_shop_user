                                    ...
                                    children: [
                                      CustomTextFieldWidget(
                                        ...
                                        validator: (value) =>
                                            ValidateCheck.validateEmptyText(
                                                value,
                                                "restaurant_tin_field_is_required"
                                                    .tr),
                                      ),
                                      const SizedBox(
                                          height: Dimensions
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  Builder(
                                                                    builder:
                                                                        (context) {
                                                                      final file = restaurantRegistrationController
                                                                          .tinFiles![
                                                                              0]
                                                                          .files[0];
                                                                      final fileName = file
            ...
            onPressed: (restaurantRegiController.storeStatus == 0.1 &&
                ...
                : () {
                    ...
                    if (restaurantRegiController.storeStatus == 0.1 ||
                      ...
                      data.addAll(RestaurantBodyModel(
                        ...
                        packageId: restaurantRegiController.businessIndex == 0
                            ...
                            : restaurantRegiController
                                ...
                                .toString(),
                        tin: tin,
                        tinExpireDate: restaurantRegiController.tinExpireDate,
                      ).toJson());
                      ...
                      restaurantRegiController.registerRestaurant(data,
                          additionalDocuments, additionalDocumentsInputType);
                    }
                  },
          ),
        ],
