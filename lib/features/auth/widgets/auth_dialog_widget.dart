...
class AuthDialogWidgetState extends State<AuthDialogWidget> {
  ...
  void initState() {
    super.initState();
    Get.find<MarketAuthController>().resetOtpView(isUpdate: false);
              ...
              child: Padding(
                ...
                child: Column(children: [
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    Image.asset(XmarketImages.logo, height: 40, width: 40),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                    Image.asset(XmarketImages.logoName, height: 50, width: 120),
                  ]),
