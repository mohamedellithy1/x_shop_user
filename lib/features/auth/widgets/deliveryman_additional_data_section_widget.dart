  ...
  Widget build(BuildContext context) {
    ...
    return deliverymanController.dataList!.isNotEmpty
        ? Container(
            ...
            margin:
                EdgeInsets.all(isDesktop ? 0 : Dimensions.paddingSizeDefault),
            ...
            child: Column(
                ...
                children: [
                  ...
                  Text('additional_info_subtitle'.tr,
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        padding: EdgeInsets.only(
                            bottom: index ==
                                    deliverymanController.dataList!.length - 1
                                ? 0
                            ...
                            ? CustomTextFieldWidget(
                                ...
                                inputType: deliverymanController
                                    ...
                                    : deliverymanController
                                            ...
                                            'phone'
                                        ? TextInputType.phone
                                        : deliverymanController.dataList![index]
                                                    .fieldType ==
                                                'email'
                                                                ...
                                                                child: isImage &&
                                                                    ...
                                                                    : DottedBorder(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Row(children: [
                                                                            Image.asset(XmarketImages.documentIcon,
                                                                                height: 30,
                                                                                width: 30,
                                                                                fit: BoxFit.contain),
                                                                            ...
                                                                            child: isImage && !GetPlatform.isWeb
                                                                                ...
                                                                                : DottedBorder(
                                                                                    ...
                                                                                    child: Container(
                                                                                      ...
                                                                                      child: Row(children: [
                                                                                        Image.asset(XmarketImages.documentIcon, height: 30, width: 30, fit: BoxFit.contain),
                                                                                        const SizedBox(width: Dimensions.paddingSizeSmall),
                                                                                        Expanded(
                                                                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                                                          Text(fileName, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
