...
class SignUpWidgetState extends State<SignUpWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      ...
      child: Container(
        ...
        child: GetBuilder<MarketAuthController>(builder: (authController) {
                    ...
                    isDesktop
                        ? Padding(
                            ...
                            child: CustomImageWidget(
                              image: Get.find<MarketSplashController>(
                                          tag: 'xmarket')
                                      .configModel
                                      ?.logoFullUrl ??
                                  '',
                        ...
                        children: [
                          ...
                          isDesktop
                              ? Expanded(
                                  ...
                                  nextFocus: Get.find<MarketSplashController>(
                                              tag: 'xmarket')
                                          .configModel!
                                          .refEarningStatus!
                                      ? _referCodeFocus
                                      : null,
                                  inputAction: Get.find<MarketSplashController>(
                                              tag: 'xmarket')
                                          .configModel!
                                          .refEarningStatus!
  ...
  void _register(
      MarketAuthController authController, String countryCode) async {
