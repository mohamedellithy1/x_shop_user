...
class SocialLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool canAppleLogin = Get.find<MarketSplashController>(tag: 'xmarket')
            .configModel!
            .appleLogin!
            .isNotEmpty &&
          ...
          canGoogleAndFacebookLogin
              ? Column(children: [
                  ...
                  Get.find<MarketSplashController>(tag: 'xmarket')
                          ...
                          child: CustomInkWellWidget(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Image.asset(XmarketImages.google,
                                        height: 20, width: 20),
                                    const SizedBox(
                      ...
                      : const SizedBox(),
                  SizedBox(
                      height: Get.find<MarketSplashController>(tag: 'xmarket')
                              .configModel!
                              .socialLogin![0]
                              .status!
                          ...
                          child: CustomInkWellWidget(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Image.asset(XmarketImages.facebookIcon,
                                        height: 20, width: 20),
                                    const SizedBox(
                                        width: Dimensions.paddingSizeSmall),
                          ...
                          child: CustomInkWellWidget(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Image.asset(XmarketImages.appleLogo,
                                        height: 20, width: 20),
                                    const SizedBox(
                                        width: Dimensions.paddingSizeSmall),
                      ...
                      child: Container(
                        ...
                        child: CustomInkWellWidget(
                          ...
                          padding:
                              const EdgeInsets.all(Dimensions.paddingSizeSmall),
                          onTap: () => _googleLogin(googleSignIn),
                          child: Image.asset(XmarketImages.google),
                        ),
                      ),
                    )
                  : const SizedBox(),
              // SizedBox(width: Get.find<MarketSplashController>(tag: 'xmarket').configModel!.socialLogin![0].status! ? Dimensions.paddingSizeLarge : 0),
              ...
              Get.find<MarketSplashController>(tag: 'xmarket')
                  ...
                  ? Padding(
                      padding: EdgeInsets.only(
                          left: Get.find<LocalizationController>(tag: 'xmarket')
                                  .isLtr
                              ? Dimensions.paddingSizeLarge
                              : 0,
                          right: Get.find<LocalizationController>(tag: 'xmarket')
                                  .isLtr
                              ? 0
                              : Dimensions.paddingSizeLarge),
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(XmarketImages.facebookIcon),
                        ),
                      ),
                    )
                  : const SizedBox(),
                  ...
                  ? Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(XmarketImages.appleLogo),
                        ),
                      ),
                    )
                  : const SizedBox(),
            ...
            Get.find<MarketAuthController>()
              ...
              if (response.isSuccess) {
                _processSocialSuccessSetup(
                    response, googleBodyModel, null, null);
              } else {
  ...
  void _appleLogin() async {
    ...
    //   clientId: Get.find<MarketSplashController>(tag: 'xmarket').configModel.appleLogin[0].clientId,
    //   redirectUri: Uri.parse('https://6ammart-web.6amtech.com/apple'),
    // ),

    print(
        'Apple Login Config Medium: ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.appleLogin![0].loginMedium}');
    print('Apple Credential Email: ${credential.email}');
    print('Apple Credential UserIdentifier: ${credential.userIdentifier}');
    print('Apple Credential IdentityToken: ${credential.identityToken}');
    print(
        'Apple Credential AuthorizationCode: ${credential.authorizationCode}');

    String? email = credential.email;
    if (email == null && credential.identityToken != null) {
      email = _decodeEmailFromToken(credential.identityToken!);
    }
    ...
    print('Apple Login Request Body: ${appleBodyModel.toJson()}');
