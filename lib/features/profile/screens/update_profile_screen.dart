...
class _UpdateProfileScreenState extends State<UpdateProfileScreen> {
  ...
  void _initCall() {
    ...
    Get.find<MarketProfileController>().getUserInfo();
    Get.find<MarketProfileController>().initData();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<OrderController>(builder: (orderController) {
      return GetBuilder<MarketProfileController>(builder: (profileController) {
                                                          ...
                                                          children: [
                                                            CustomTextFieldWidget(
                                                              ...
                                                              countryDialCode: _countryDialCode ??
                                                                  CountryCode.fromCountryCode(Get.find<MarketSplashController>(
                                                                              tag: 'xmarket')
                                                                          .configModel!
                                                                          .country!)
                                                                      .code,
                                                                  ...
                                                                  ? InkWell(
                                                                      onTap:
                                                                        ...
                                                                        if (!profileController.userInfoModel!.isPhoneVerified! &&
                                                                            Get.find<MarketSplashController>(tag: 'xmarket').configModel!.centralizeLoginSetup!.phoneVerificationStatus!) {
                                                                          Get.dialog(
                                                                              CustomLoaderWidget());
  ...
  Widget webView(MarketProfileController profileController, bool isLoggedIn) {
                    ...
                    ClipOval(
                        child: profileController.pickedFile != null
                            ...
                            : CustomImageWidget(
                                ...
                                fit: BoxFit.cover,
                                placeholder: isLoggedIn
                                    ? XmarketImages.profilePlaceholder
                            ...
                            children: [
                              !_isPhoneLoading
                                  ? CustomTextFieldWidget(
                                      ...
                                      countryDialCode: _countryDialCode ??
                                          CountryCode.fromCountryCode(Get.find<
  ...
  Future<void> _updateProfile(
      {required MarketProfileController profileController,
    ...
    // }
      ...
      await profileController.updateUserInfo(
          updatedUser, Get.find<MarketAuthController>().getUserToken(),
