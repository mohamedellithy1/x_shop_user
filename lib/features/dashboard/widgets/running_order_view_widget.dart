                    ...
                    child: Padding(
                      ...
                      child: Row(
                          ...
                          children: [
                            Center(
                              child: SizedBox(
                                height: orderStatus == OrderStatus.pending.name
                                    ? 50
                                    : 60,
                                width: orderStatus == OrderStatus.pending.name
                                    ? 50
                                    : 60,
                                child: Padding(
                                  ...
                                  child: Image.asset(
                                      status == 2
                                          ? orderStatus ==
                                              ...
                                              ? XmarketImages.processingGif
                                              : XmarketImages.cookingGif
                                          : status == 3
                                              ? orderStatus ==
                                                      OrderStatus.handover.name
                                                  ? XmarketImages.handoverGif
                                                  : XmarketImages.onTheWayGif
                                              : XmarketImages.pendingGif,
                                      height: 60,
                                      width: 60,
                                      fit: BoxFit.fill),
                                ),
