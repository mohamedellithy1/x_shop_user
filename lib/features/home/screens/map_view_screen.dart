...
class _MapViewScreenState extends State<MapViewScreen> {
    ...
    try {
      BitmapDescriptor restaurantMarkerIcon =
          await MarkerHelper.convertAssetToBitmapDescriptor(
              width: 50, imagePath: XmarketImages.nearbyRestaurantMarker);
      BitmapDescriptor myLocationMarkerIcon =
          await MarkerHelper.convertAssetToBitmapDescriptor(
              width: 50, imagePath: XmarketImages.myLocationMarker);
  ...
  void _setMarkerForWeb(List<Restaurant> restaurants) async {
    ...
    //   Get.find<MarketLocationController>().zoomToFit(_controller, _latLngs, padding: 0);
    // }
