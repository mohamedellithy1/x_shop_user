  ...
  Widget build(BuildContext context) {
    return Get.find<MarketSplashController>(tag: 'xmarket')
        ...
        ? Padding(
            ...
            child: SizedBox(
              height: ResponsiveHelper.isMobile(context) ? 75 : 122,
              width: Dimensions.webMaxWidth,
              child: ClipRRect(
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                child: CustomImageWidget(
                  placeholder: XmarketImages.placeholder,
                  image:
                      '${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.bannerData!.promotionalBannerImageFullUrl}',
                  fit: BoxFit.fitWidth,
                ),
              ),
            ),
