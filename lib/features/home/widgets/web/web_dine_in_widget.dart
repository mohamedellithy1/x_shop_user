...
class _WebDineInWidgetState extends State<WebDineInWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DineInController>(builder: (dineInController) {
      return dineInController.dineInModel?.restaurants != null &&
                        ...
                        ? SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                bool isAvailable = (dineInController
                                            .dineInModel!
                                            .restaurants![index]
                                            .open ==
                                        1) &&
                                    dineInController.dineInModel!
                                        .restaurants![index].active!;

                                double distance =
                                    Get.find<RestaurantController>()
                                        .getRestaurantDistance(
                                  LatLng(
                                      double.parse(dineInController.dineInModel!
                                                        ...
                                                        Container(
                                                          ...
                                                          child: ClipRRect(
                                                            ...
                                                            child:
                                                                CustomImageWidget(
                                                              image:
                                                                  '${dineInController.dineInModel!.restaurants![index].logoFullUrl}',
                                                              fit: BoxFit.cover,
                                                              height: 65,
                                                              width: 65,
                                                              isRestaurant:
