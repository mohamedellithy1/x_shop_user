...
// import 'package:stackfood_multivendor/xride/localization/localization_controller.dart';
          ...
          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Padding(
                padding: EdgeInsets.only(
                  ...
                  left: Get.find<LocalizationController>(tag: 'xmarket').isLtr
                      ? Dimensions.paddingSizeExtraSmall
                      : 0,
                  right: Get.find<LocalizationController>(tag: 'xmarket').isLtr
                      ? 0
                      : Dimensions.paddingSizeExtraSmall,
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Material(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    // print('onTap: ${categoryController.categoryList![index].name!}');
                                    Get.toNamed(
