          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(children: [
                ...
                Text(
                  '${'get_ready_for_a_special_welcome_gift_enjoy_a_special_discount_on_your_first_order_within'.tr} ${Get.find<MarketProfileController>().userInfoModel!.validity}. ${'start_exploring_the_best_services_around_you'.tr}',
