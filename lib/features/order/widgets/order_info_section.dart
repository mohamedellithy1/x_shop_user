...
class OrderInfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool refundRequested =
        order.orderStatus == OrderStatus.refund_requested.name;
    bool refundRequestCanceled =
        order.orderStatus == OrderStatus.refund_request_canceled.name;
    ...
    bool ongoing = ((isDineIn ? true : !delivered) &&
        !failed &&
        !refundRequested &&
        !refunded &&
    ...
    bool pastOrder = ((isDineIn ? false : delivered) ||
        failed ||
        refundRequested ||
        refunded ||
        refundRequestCanceled ||
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          DateConverter.isBeforeTime(order.scheduleAt) || isDineIn
              ...
              : const SizedBox(),
          // SizedBox(
          //     height: DateConverter.isBeforeTime(order.scheduleAt) || isDineIn
          //         ? (!cancelled && ongoing && !subscription)
          //             ? isDineIn
          //                 ? Dimensions.paddingSizeSmall
          //                 : Dimensions.paddingSizeSmall
          ...
          CustomCard(
            ...
            child:
              ...
              (isDineIn || takeAway)
                  ? Row(children: [
                      Text(
                          '${isDineIn ? 'dine_in_date'.tr : 'estimated_arrival_time'.tr}:',
                          style: robotoRegular),
                      Spacer(),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                      Text(
                          ...
                          children: [
                            (order.orderReference!.tokenNumber != null &&
                                ...
                                ? Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                        Image.asset(XmarketImages.couponIcon,
                                            height: 20,
                                            width: 20,
                                            color:
                                ...
                                : const SizedBox(),
                            (order.orderReference!.tableNumber != null &&
                                    order.orderReference!.tableNumber!
                                        .isNotEmpty)
                                ? Text(
      ...
      (order.orderReference != null &&
          ...
          ? Container(
              ...
              child: Row(
                  ...
                  children: [
                    (order.orderReference!.tokenNumber != null &&
                            order.orderReference!.tokenNumber!.isNotEmpty)
                        ? Expanded(
                            child: Center(
                              child: Row(
                                  mainAxisSize: MainAxisSize.min,
                    ...
                    // (order.orderReference!.tableNumber != null &&
                    //             order
                    //                 .orderReference!.tableNumber!.isNotEmpty) &&
                    //         (order.orderReference!.tokenNumber != null &&
                    //             order.orderReference!.tokenNumber!.isNotEmpty)
                    //     ? Container(
                    //         height: 40,
                    ...
                    //     : SizedBox(),
                    (order.orderReference!.tableNumber != null &&
                            order.orderReference!.tableNumber!.isNotEmpty)
                        ? Expanded(
                            child: Center(
                              child: Text(
                                '${'table_no'.tr} - ${order.orderReference!.tableNumber}',
                                style:
                                    robotoRegular.copyWith(color: Colors.blue),
                              ),
                            ),
                          )
                        : SizedBox(),
                  ...
                  children: [
                    ...
                    Wrap(children: [
                      ...
                      (order.deliveryAddress?.floor != null &&
                              order.deliveryAddress!.floor!.isNotEmpty)
                          ? RichText(
                              text: TextSpan(children: [
                                TextSpan(
                                    text: '${'floor'.tr} : ',
                    ...
                    SizedBox(
                      height: (order.deliveryAddress?.road != null &&
                                  order.deliveryAddress!.road!.isNotEmpty) ||
                              (order.deliveryAddress?.house != null &&
                                  order.deliveryAddress!.house!.isNotEmpty) ||
                              (order.deliveryAddress?.floor != null &&
      ...
      !isDineIn ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: isDesktop ? themeController.darkTheme ? Colors.white : Colors.black.withValues(alpha: 0.05) : Theme.of(context).primaryColor.withValues(alpha: 0.05), blurRadius: 10)],
          ),
          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      CustomCard(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          //     child: Divider()),
          InkWell(
            onTap: () => Get.toNamed(RouteHelper.getRestaurantRoute(
                order.restaurant?.id,
                        ...
                        ? Row(children: [
                            ...
                            isDineIn
                                ? InkWell(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Image.asset(
                                          XmarketImages.restaurantIconMarker,
                                          height: 25,
                                          width: 25,
                                          fit: BoxFit.cover),
                                    ),
                            ...
                            (showChatPermission &&
                                ...
                                ? InkWell(
                                    ...
                                    child: Image.asset(
                                        XmarketImages.chatImageOrderDetails,
                                        height: 25,
                                        width: 25,
                                        color: Colors.blue,
                                        fit: BoxFit.cover),
                            ...
                            SizedBox(
                                width: order.restaurant!.phone != null
                                    ? Dimensions.paddingSizeDefault
                                    : 0),
                            (!pastOrder && order.restaurant!.phone != null)
                                ? InkWell(
                                    onTap: () async {
                                    ...
                                    child: Image.asset(
                                        XmarketImages.callImageOrderDetails,
                                        height: 25,
                                        width: 25,
                                        color: Colors.blue,
                                        fit: BoxFit.cover),
                          ...
                          children: [
                            Row(children: [
                              ClipOval(
                                ...
                                width: 35,
                                fit: BoxFit.cover,
                                placeholder: XmarketImages.profilePlaceholder,
                              )),
                              const SizedBox(
                              ...
                              Expanded(
                                  child: Column(
                                    ...
                                    RatingBarWidget(
                                      ...
                                      size: 10,
                                      ratingCount:
                                          order.deliveryMan!.ratingCount,
                                    ),
                                  ])),
                              (!pastOrder && !isGuestLoggedIn)
                                  ? InkWell(
                                      onTap: () async {
                                        orderController.cancelTimer();
                                        await Get.toNamed(
...
Widget offlineView(BuildContext context, OrderController orderController,
    ExpansibleController controller, bool ongoing, String? contactNumber) {
