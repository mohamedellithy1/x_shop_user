...
class WebBonusBannerViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MarketWalletController>(builder: (walletController) {
                                  ...
                                  Expanded(
                                      child: Column(
                                        ...
                                        Text(
                                          ...
                                          '${walletController.fundBonusList![index1].bonusType == 'amount' ? Get.find<MarketSplashController>(tag: 'xmarket').configModel!.currencySymbol : '%'} ${'bonus'.tr}',
                                            ...
                                            Expanded(
                                                child: Column(
                                                  ...
                                                  Text(
                                                    ...
                                                    '${walletController.fundBonusList![index2].bonusType == 'amount' ? Get.find<MarketSplashController>(tag: 'xmarket').configModel!.currencySymbol : '%'} ${'bonus'.tr}',
                                                    style:
  ...
  Widget build(BuildContext context) {
    return const SizedBox(
      ...
      child: Padding(
        ...
        child: Row(children: [
          Expanded(child: Skeleton(height: 220)),
