...
class CategoryProductScreenState extends State<CategoryProductScreen> {
  ...
  void initState() {
    ...
    Get.find<CategoryController>().clearCategoryData();
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
          ...
          !Get.find<CategoryController>().paginate) {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryController>(builder: (catController) {
      ...
      return Scaffold(
        backgroundColor:
            Get.find<ThemeController>().darkTheme ? Colors.black : Colors.white,
                                ...
                                return InkWell(
                                  onTap: () {
                                    Get.toNamed(
                                      ...
                                      planId: int.tryParse(
                                          Get.parameters['planId'] ?? ''),
                                      variantId: int.tryParse(
                                          Get.parameters['variantId'] ?? ''),
                                      variantTitle:
                                          Get.parameters['variantTitle'],
                                    ))?.then((value) {
                                      if (widget.forceProductView) {
                                        Get.find<CategoryController>()
