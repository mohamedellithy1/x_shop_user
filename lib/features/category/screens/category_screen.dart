...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  void initState() {
    ...
    Get.find<MarketCategoryController>().clearSearch(isUpdate: false);
  }
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        Get.find<MarketCategoryController>().clearSearch();
      },
      child: Scaffold(
        ...
        body: GetBuilder<MarketCategoryController>(builder: (catController) {
          return SafeArea(
