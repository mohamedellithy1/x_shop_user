                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  isLoggedIn ? InkWell(
                    onTap: () async {
                      ...
                      bool isRunningOrderAvailable = Get.find<OrderController>().runningOrderList != null && Get.find<OrderController>().runningOrderList!.isNotEmpty;
                        ...
                        builder: (context) {
                          return ConstrainedBox(
                            ...
                            child: AccountDeletionBottomSheet(
                              ...
                              isRunningOrderAvailable: isRunningOrderAvailable,
                            ),
                          );
                        },
                      );
                    ...
                    child: Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        Container(
                          ...
                          child: const Icon(Icons.delete_forever, size: 14, color: Colors.white),
                        ),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
          
                        Text('delete_account'.tr, style: robotoMedium),
                      ]),
                    ),
                  ) : const SizedBox(),

                  isLoggedIn ? const SizedBox(height: Dimensions.paddingSizeSmall) : const SizedBox(),
