                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('pick_your_location'.tr,
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.fontSizeDefault)),
                          Text('sharing_your_accurate_location'.tr,
                            ...
                            child: Stack(children: [
                              ClipRRect(
                                ...
                                child: GoogleMap(
                                  ...
                                  onCameraMoveStarted: () {
                                    locationController
                                        .updateCameraMovingStatus(true);
                                    locationController.disableButton();
                                  },
                                  onCameraIdle: () {
                                    locationController
                                        .updateCameraMovingStatus(false);
              ...
              : Stack(children: [
                  ...
                  Positioned(
                    ...
                    child: FloatingActionButton(
                      mini: true,
                      backgroundColor: Theme.of(context).cardColor,
                      onPressed: () => Get.find<MarketLocationController>()
                          .checkPermission(() {
                        Get.find<MarketLocationController>().getCurrentLocation(
                            false,
                            mapController: _mapController);
