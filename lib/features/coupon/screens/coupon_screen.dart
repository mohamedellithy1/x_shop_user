    ...
    return Scaffold(
      ...
      body: _isLoggedIn
          ? GetBuilder<MarketCouponController>(builder: (couponController) {
              bool hasAvailable = couponController.customerCouponModel?.available != null && couponController.customerCouponModel!.available!.isNotEmpty;
              bool hasUnavailable = couponController.customerCouponModel?.unavailable != null && couponController.customerCouponModel!.unavailable!.isNotEmpty;

              return (couponController.customerCouponModel != null && _availableToolTipControllerList != null && _unavailableToolTipControllerList != null)
                                            ...
                                            children: [
                                              if (hasAvailable) ...[
                                                Padding(
                                                  ...
                                                  child: Text('available_promo'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.find<MarketThemeController>(tag: 'xmarket').darkTheme ? Colors.white : Colors.black)),
                                                ),
                                                GridView.builder(
                                                  ...
                                                  itemCount: couponController.customerCouponModel?.available?.length ?? 0,
                                                  shrinkWrap: true,
                                                  physics: const NeverScrollableScrollPhysics(),
                                                  padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                                                  itemBuilder: (context, index) {
                                                    return JustTheTooltip(
                                                      backgroundColor: Get.find<MarketThemeController>(tag: 'xmarket').darkTheme ? const Color(0xFF1b1b1b) : Colors.black87,
                                                      ...
                                                      content: Padding(
                                                        ...
                                                        child: Text('${'code_copied'.tr} !', style: robotoRegular.copyWith(color: Colors.white)),
                                                      ),
                                                      child: InkWell(
                                                        ...
                                                        child: CouponCardWidget(
                                                          couponList: couponController.customerCouponModel!.available,
                                              ...
                                              if (hasUnavailable) ...[
                                                Padding(
                                                  padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge, right: Dimensions.paddingSizeLarge, top: Dimensions.paddingSizeDefault),
                                                  child: Text('unavailable_promo'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.find<MarketThemeController>(tag: 'xmarket').darkTheme ? Colors.white : Colors.black)),
                                                ),
                                                GridView.builder(
                                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                    crossAxisCount: ResponsiveHelper.isDesktop(context) ? 3 : ResponsiveHelper.isTab(context) ? 2 : 1,
                                                  ...
                                                  itemCount: couponController.customerCouponModel?.unavailable?.length ?? 0,
                                                  shrinkWrap: true,
                                                  physics: const NeverScrollableScrollPhysics(),
                                                  padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                                                  itemBuilder: (context, index) {
                                                    return CouponCardWidget(
                                                      couponList: couponController.customerCouponModel!.unavailable,
