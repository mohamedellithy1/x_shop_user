      ...
      child: Stack(children: [
        ClipRRect(
          ...
          child: Transform.rotate(
            angle:
                Get.find<LocalizationController>(tag: 'xmarket').isLtr ? 0 : pi,
            child: Image.asset(
              Get.find<MarketThemeController>(tag: 'xmarket').darkTheme
                  ? XmarketImages.couponBgDark
                  : XmarketImages.couponBgLight,
                  ...
                  children: [
                    Image.asset(
                      couponList![index].discountType == 'percent'
                          ? XmarketImages.percentCouponOffer
                          : couponList![index].couponType == 'free_delivery'
                              ? XmarketImages.freeDelivery
                              : XmarketImages.money,
                      height: 25,
                      width: 25,
                    ),
