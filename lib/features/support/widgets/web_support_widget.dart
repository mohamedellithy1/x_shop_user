                      ...
                      child: Column(children: [
                        Row(children: [
                          ...
                          Expanded(
                            ...
                            child: ElementWidget(
                                image: XmarketImages.helpPhone,
                                title: 'call'.tr,
                                subTitle: Get.find<MarketSplashController>(
                                        tag: 'xmarket')
                                    .configModel!
                                    .phone!,
                                onTap: () async {
                                  if (await canLaunchUrlString(
                                      'tel:${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.phone}')) {
                                    launchUrlString(
                                        'tel:${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.phone}',
                                        mode: LaunchMode.externalApplication);
                                  } else {
                                    showCustomSnackBar(
                                        '${'can_not_launch'.tr} ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.phone}');
                                  }
                                }),
                          )),
                          const SizedBox(
                          ...
                          Expanded(
                            child: CustomCardWidget(
                              child: ElementWidget(
                                image: XmarketImages.helpAddress,
                                title: 'address'.tr,
                                subTitle: Get.find<MarketSplashController>(
                                        tag: 'xmarket')
                                    .configModel!
                            ...
                            child: ElementWidget(
                              ...
                              onTap: () {
                                final Uri emailLaunchUri = Uri(
                                  scheme: 'mailto',
                                  path: Get.find<MarketSplashController>(
                                          tag: 'xmarket')
                                      .configModel!
                                      .email,
                                );
