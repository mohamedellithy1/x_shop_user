    ...
    return GetBuilder<MarketAddressController>(
        ...
        builder: (_) {
          return Scaffold(
            ...
            floatingActionButton: isDeskTop || !isLoggedIn
                ? null
            ...
            floatingActionButtonLocation:
                isDeskTop ? FloatingActionButtonLocation.centerFloat : null,
            body: GetBuilder<MarketAddressController>(
                id: 'xmarket',
                global: false,
                init: addressController,
                builder: (_) {
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: addressController.addressList != null
                                    ? AssetImage(addressController
                                            .addressList!.isNotEmpty
                                        ? XmarketImages.city
                                        : XmarketImages.cityWhite)
                                    : const AssetImage(XmarketImages.city),
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                            'add_new_address'
                                                                                .tr,
                                                                            style:
                                                                                robotoRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)),
                                                                      ]),
                                                                ),
                                                              ),
                                                            )
