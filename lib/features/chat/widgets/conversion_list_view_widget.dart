...
//               baseUrl = Get.find<MarketSplashController>(tag: 'xmarket').configModel!.baseUrls!.restaurantImageUrl;
//             }else if(type == UserType.delivery_man.name) {
//               baseUrl = Get.find<MarketSplashController>(tag: 'xmarket').configModel!.baseUrls!.deliveryManImageUrl;
//             }else if(type == UserType.admin.name){
//               baseUrl = Get.find<MarketSplashController>(tag: 'xmarket').configModel!.baseUrls!.businessLogoUrl;
//             }
//
//             return Column(
//               children: [
...
//                         if(Get.find<MarketProfileController>().userInfoModel == null || Get.find<MarketProfileController>().userInfoModel!.userInfo == null) {
...
//
//                       Positioned(
//                         right: Get.find<LocalizationController>(tag: 'xmarket').isLtr ? 5 : null, top: 15, left: Get.find<LocalizationController>(tag: 'xmarket').isLtr ? null : 5,
//                         child: Text(
...
//                             && widget.conversation!.conversations![index]!.unreadMessageCount! > 0) ? Positioned(right: Get.find<LocalizationController>(tag: 'xmarket').isLtr ? 5 : null, bottom: 8, left: Get.find<LocalizationController>(tag: 'xmarket').isLtr ? null : 5,
//                           child: Container(
                      ...
                      return Container(
                        ...
                        child: CustomInkWellWidget(
                          ...
                          child: Stack(children: [
                            ...
                            GetBuilder<MarketProfileController>(
