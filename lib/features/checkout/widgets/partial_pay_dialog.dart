    ...
    return Dialog(
      ...
      child: SizedBox(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Image.asset(XmarketImages.note, width: 35, height: 35),
          ...
          Image.asset(XmarketImages.partialWallet, height: 35, width: 35),
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Text(
            PriceConverter.convertPrice(Get.find<MarketProfileController>()
                .userInfoModel!
                .walletBalance!),
          ...
          Padding(
            ...
            child: Text(
              isPartialPay
                  ...
                  : '${'remaining_wallet_balance'.tr}: ${PriceConverter.convertPrice(Get.find<MarketProfileController>().userInfoModel!.walletBalance! - totalPrice)}',
              style: robotoMedium.copyWith(
                  fontSize: Dimensions.fontSizeLarge,
