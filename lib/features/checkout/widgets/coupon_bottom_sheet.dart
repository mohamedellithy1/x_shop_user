...
class _CouponBottomSheetState extends State<CouponBottomSheet> {
  ...
  void initState() {
    ...
    if (Get.find<MarketCouponController>().customerCouponModel?.available !=
      ...
      for (var coupon in Get.find<MarketCouponController>()
          .customerCouponModel!
          .available!) {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: GetBuilder<MarketCouponController>(builder: (couponController) {
        return Column(
          children: [
            ...
            Expanded(
              child: _availableCouponList != null &&
                      _availableCouponList!.isNotEmpty
                  ? SingleChildScrollView(
                      ...
                      child: Column(children: [
                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              ...
                              child: CouponCardWidget(
                                ...
                                index: index,
                                onCopyClick: () {
                                  if (_availableCouponList![index].code !=
                                      null) {
                                    widget.checkoutController.couponController
                                            .text =
                                        _availableCouponList![index]
                        ...
                        _unavailableCouponList != null &&
                                _unavailableCouponList!.isNotEmpty
                            ? Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: Dimensions.paddingSizeDefault,
                                ...
                                child: Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text('unavailable_promo'.tr,
                                        style: robotoBold.copyWith(
                                            fontSize:
                  ...
                  : Column(
                      children: [
                        Lottie.asset("assets/image/offer.json", height: 200),
