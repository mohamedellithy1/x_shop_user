...
class OfflineSuccessDialog extends StatelessWidget {
  ...
  const OfflineSuccessDialog(
      {super.key, required this.orderId, this.isDineIn = false});
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
              isDineIn
                  ? Image.asset(
                      XmarketImages.successAnimationDineIn,
                      height: 100,
                      width: 100,
                    )
                      ...
                      GetBuilder<OrderController>(builder: (orderController) {
                        return Container(
                          ...
                          child: orderController.trackModel != null
                              ? ListView.builder(
                                  itemCount: orderController.trackModel!
                                      .offlinePayment!.input!.length,
                                  shrinkWrap: true,
                                  physics: const NeverScrollableScrollPhysics(),
                                  padding: EdgeInsets.zero,
                                  itemBuilder: (context, index) {
                                    Input data = orderController.trackModel!
                                        .offlinePayment!.input![index];
                                    return Padding(
                                      padding: const EdgeInsets.symmetric(
                                          vertical:
                      ...
                      RichText(
                          ...
                          text: TextSpan(children: [
                            TextSpan(
                                text: '*',
                                style:
                                    robotoMedium.copyWith(color: Colors.red)),
                            TextSpan(
