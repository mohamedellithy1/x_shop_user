...
class TopSectionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CheckoutController>(builder: (checkoutController) {
      print(
          " Get.find<MarketSplashController>(tag: 'xmarket').configModel!.partialPaymentStatus ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.partialPaymentStatus}");
      print(
          " Get.find<MarketSplashController>(tag: 'xmarket').configModel!.customerWalletStatus ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.customerWalletStatus}");
      print(
          "Get.find<MarketSplashController>(tag: 'xmarket').configModel!.offlinePaymentStatus ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.offlinePaymentStatus}");
      ...
      return Column(children: [
                    ...
                    children: [
                      ...
                      Row(children: [
                        Expanded(
                          ...
                          title: 'regular'.tr,
                          icon: XmarketImages.regularOrder,
                        ...
                        Expanded(
                          ...
                          icon: XmarketImages.subscriptionOrder,
                          isSelected: checkoutController.subscriptionOrder,
                          onTap: () {
                      ...
                      SingleChildScrollView(
                          ...
                          child: Row(children: [
                            (Get.find<MarketSplashController>(tag: 'xmarket')
                                ...
                                : const SizedBox(),
                            SizedBox(
                                width: (Get.find<MarketSplashController>(
                                                tag: 'xmarket')
                                            .configModel!
                                            .homeDelivery! &&
                                        checkoutController
        ...
        DeliverySection(
          ...
          guestStreetNumberController: guestStreetNumberController,
          guestStreetNumberNode: guestStreetNumberNode,
          guestFloorController: guestFloorController,
          guestHouseController: guestHouseController,
          guestNameNode: guestNameNode,
          guestNumberNode: guestNumberNode,
          guestEmailNode: guestEmailNode,
          guestAddressNode: guestAddressNode,
