...
class _TimeSlotBottomSheetState extends State<TimeSlotBottomSheet> {
  ...
  void initState() {
    super.initState();
    _instanceOrder = (Get.find<MarketSplashController>(tag: 'xmarket')
            .configModel!
            .instantOrder! &&
                                    ...
                                    SfDateRangePicker(
                                      ...
                                      selectableDayPredicate: (DateTime val) {
                                        return _canSelectDate(
                                            duration: isRestaurantSelfDeliveryOn
                                                ? widget.restaurant
                                                    .customerOrderDate!
                        ...
                        child: Row(children: [
                          Expanded(
                            child: Container(
                              ...
                              child: CustomButtonWidget(
                                isBorder: true,
                                textColor: Get.find<MarketThemeController>(
                                            tag: 'xmarket')
                                        .darkTheme
                                    ? Colors.white
                                    : Colors.black,
                          ...
                          Expanded(
                            child: CustomButtonWidget(
                              ...
                              onPressed: () {
                                checkoutController
                                    .updateDateSlotIndex(selectedDateSlotIndex);
