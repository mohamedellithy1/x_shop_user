...
class _DeliveryInfoFieldsState extends State<DeliveryInfoFields> {
  ...
  void initState() {
    ...
    Get.find<MarketLocationController>().updateAddress(address);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MarketLocationController>(builder: (locationController) {
      ...
      return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(
              takeAway || isDineIn ? 'contact_information'.tr : 'deliver_to'.tr,
              style: robotoMedium),
          const SizedBox(height: Dimensions.paddingSizeDefault),
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
              border: takeAway || isDineIn
                  ? Border.all(
                      color:
                          Theme.of(context).primaryColor.withValues(alpha: 0.2))
                  : null,
            ),
            child: takeAway || isDineIn
                ? Column(children: [
                    Padding(
                      padding:
                ...
                : Column(
                    ...
                    children: [
                          ...
                          child: Visibility(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Text('${'add_more_details'.tr} +',
                        ...
                        //             inputType: TextInputType.streetAddress,
                        //             controller:
                        //                 widget.guestStreetNumberController,
