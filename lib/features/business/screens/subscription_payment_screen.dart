              ...
              child: SingleChildScrollView(
                child: SizedBox(
                  ...
                  child: Column(children: [
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          Get.find<MarketSplashController>(tag: 'xmarket')
                              ...
                              ? PaymentCartWidget(
                                  title:
                                      '${'continue_with'.tr} ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.subscriptionFreeTrialDays} '
                                      '${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.subscriptionFreeTrialType} ${'days_free_trial'.tr}',
                                  index: 0,
                                  onTap: () {
                              ...
                              : const SizedBox(),
                          SizedBox(
                              height: Get.find<MarketSplashController>(
                                              tag: 'xmarket')
                                          .configModel!
                                          .subscriptionFreeTrialStatus ??
                                      false
                          ...
                          Get.find<MarketSplashController>(tag: 'xmarket')
                              ...
                              ? Column(children: [
                                  ...
                                  GridView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: Get.find<MarketSplashController>(
                                            tag: 'xmarket')
                                        .configModel!
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(children: [
                                            ...
                                            CustomImageWidget(
                                              ...
                                              fit: BoxFit.contain,
                                              image:
                                                  '${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.activePaymentMethodList![index].getWayImageFullUrl}',
                                            ),
                                            const SizedBox(
                                                width: Dimensions
                                                    .paddingSizeDefault),
                    ...
                    SizedBox(
                        height:
                            isDesktop ? Dimensions.paddingSizeOverLarge : 0),
                    isDesktop
                        ? Row(
                            ...
                            children: [
                                CustomButtonWidget(
                                  ...
                                  onPressed: () {
                                    if ((Get.find<MarketSplashController>(
                                                    tag: 'xmarket')
                                                .configModel!
                                                .subscriptionFreeTrialStatus ==
                                            false) &&
                    ...
                    child: CustomButtonWidget(
                      ...
                      onPressed: () {
                        if ((Get.find<MarketSplashController>(tag: 'xmarket')
                                    ...
                                    .subscriptionFreeTrialStatus ==
                                false) &&
                            (businessController.paymentIndex == 0)) {
