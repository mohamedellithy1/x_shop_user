              ...
              Get.find<MarketSplashController>(tag: 'xmarket')
                  ...
                  ? Expanded(
                      child: BaseCardWidget(
                        ...
                        description:
                            "${'restaurant_will_pay'.tr} ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.adminCommission}% ${'commission_to'.tr} ${Get.find<MarketSplashController>(tag: 'xmarket').configModel!.businessName} ${'from_each_order_You_will_get_access_of_all'.tr}",
                        index: 0,
                        onTap: () => restaurantRegController.setBusiness(0),
                      ),
                    )
                  : const SizedBox(),
              SizedBox(
                  width: Get.find<MarketSplashController>(tag: 'xmarket')
                              .configModel!
                              .commissionBusinessModel !=
                          0
                      ...
                      child: BaseCardWidget(
                        ...
                        description:
                            'run_restaurant_by_purchasing_subscription_packages'
                                .tr,
                        index: 1,
                        onTap: () => restaurantRegController.setBusiness(1),
                      ),
                    )
                  : const SizedBox(),
            ]),
            restaurantRegController.businessIndex == 1
                ? Column(children: [
                                ...
                                ? Swiper(
                                    ...
                                    itemBuilder: (context, index) {
                                      return PackageCardWidget(
                                        canSelect: restaurantRegController
