...
class BaseCardWidget extends StatelessWidget {
  ...
  const BaseCardWidget(
      {super.key,
      required this.restaurantRegistrationController,
      required this.title,
      required this.index,
      required this.onTap,
      this.description});
      ...
      child: Stack(clipBehavior: Clip.none, children: [
        Container(
          decoration: BoxDecoration(
            ...
            color: restaurantRegistrationController.businessIndex == index
                ? Theme.of(context).primaryColor.withValues(alpha: 0.05)
                : Theme.of(context).cardColor,
            border: restaurantRegistrationController.businessIndex == index &&
                    isDesktop
                ? Border.all(color: Theme.of(context).primaryColor)
                : !isDesktop
                    ? Border.all(
                        color: restaurantRegistrationController.businessIndex ==
                                index
                        ...
                        width: 0.5)
                    : null,
            boxShadow: restaurantRegistrationController.businessIndex == index
                ? null
                : [
                    BoxShadow(
        ...
        restaurantRegistrationController.businessIndex == index
            ? Positioned(
                top: -10,
                right: -10,
                child: Container(
