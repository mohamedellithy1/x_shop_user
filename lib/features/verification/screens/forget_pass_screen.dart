...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
  ...
  void initState() {
    ...
    isPhone = (Get.find<MarketSplashController>(tag: 'xmarket')
            .configModel!
            .isSmsActive! ||
        Get.find<MarketSplashController>(tag: 'xmarket')
            .configModel!
            .firebaseOtpVerification!);
    isEmail = Get.find<MarketSplashController>(tag: 'xmarket')
        .configModel!
        .isMailActive!;
            ...
            child: Column(children: [
              ...
              (isPhone || isEmail)
                  ? Padding(
                      ...
                      child: Column(children: [
                        Image.asset(XmarketImages.logo,
                        ...
                        GetBuilder<VerificationController>(
                          ...
                          return GetBuilder<MarketAuthController>(
                      ...
                      padding: widget.fromDialog
                          ...
                          : context.width > 700
                              ...
                              : const EdgeInsets.all(
                                  Dimensions.paddingSizeLarge),
                      child: Column(children: [
                        Image.asset(XmarketImages.forgot,
