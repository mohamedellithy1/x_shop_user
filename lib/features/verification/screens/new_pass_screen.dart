...
class _NewPassScreenState extends State<NewPassScreen> {
  ...
  void _changeUserPassword(String password) {
    UserInfoModel user = Get.find<MarketProfileController>().userInfoModel!;
    user.password = password;
    Get.find<MarketProfileController>().changePassword(user).then((response) {
  ...
  void _resetUserPassword(String password, String confirmPassword) {
    ...
    Get.find<VerificationController>()
      ...
      if (value.isSuccess) {
        ...
        showCustomSnackBar('password_reset_successfully'.tr);
      } else {
