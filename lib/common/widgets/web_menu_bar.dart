            ...
            child: SizedBox(
              ...
              child: Row(children: [
                ...
                GetBuilder<LocalizationController>(
                    init: Get.find<LocalizationController>(tag: 'xmarket'),
                ...
                GetBuilder<MarketThemeController>(
                    id: 'xmarket',
          ...
          child: Center(
            ...
            child: Row(children: [
              InkWell(
                ...
                child: Row(children: [
                  Image.asset(XmarketImages.logo, height: 30, width: 40),
                  Image.asset(XmarketImages.logoName, height: 40, width: 100),
                ]),
              ),
  ...
  Widget build(BuildContext context) {
    return TextHoverWidget(builder: (hovered) {
      return IconButton(
        ...
        icon: GetBuilder<MarketCartController>(builder: (cartController) {
