...
class DiscountTagWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isRightSide = Get.find<MarketSplashController>(tag: 'xmarket')
        ...
        'right';
    String currencySymbol = Get.find<MarketSplashController>(tag: 'xmarket')
        .configModel!
        .currencySymbol!;
                ...
                child: CustomPaint(
                  ...
                  child: Container(
                    ...
                    child: Align(
                      child: Text(
                        discount! > 0
                            ? '${(isRightSide || discountType == 'percent') ? '' : currencySymbol}$discount${discountType == 'percent' ? '%' : isRightSide ? ' EG ' : ' EG '} ${'off'.tr}'
                            : 'free_delivery'.tr,
